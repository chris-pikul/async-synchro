...
export default class Mutex {
    ...
    cancelAll(err) {
        ...
        __classPrivateFieldGet(this, _Mutex_queue, "f").forEach(({ reject }) => { var _a; return reject((_a = err !== null && err !== void 0 ? err : this.options.errorCancelled) !== null && _a !== void 0 ? _a : ErrCancelled); });
        __classPrivateFieldSet(this, _Mutex_queue, [], "f");
        // Unlock the mutex
        __classPrivateFieldSet(this, _Mutex_locked, false, "f");
