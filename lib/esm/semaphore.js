...
var _Semaphore_instances, _Semaphore_maxConcurrent, _Semaphore_allowed, _Semaphore_queue, _Semaphore_enque, _Semaphore_dispatch;
import { ErrCancelled } from './errors';
;
/**
...
export default class Semaphore {
    ...
    constructor(maxConcurrent, options) {
        ...
        this.options = Object.assign(Object.assign({}, Semaphore.DefaultOptions), (options !== null && options !== void 0 ? options : {}));
    ...
    acquire() {
        ...
        const prom = new Promise((res, rej) => __classPrivateFieldGet(this, _Semaphore_instances, "m", _Semaphore_enque).call(this, res, rej));
    ...
    cancelAll() {
        ...
        __classPrivateFieldGet(this, _Semaphore_queue, "f").forEach(({ reject }) => { var _a; return reject((_a = this.options.errorCancelled) !== null && _a !== void 0 ? _a : ErrCancelled); });
...
_Semaphore_maxConcurrent = new WeakMap(), _Semaphore_allowed = new WeakMap(), _Semaphore_queue = new WeakMap(), _Semaphore_instances = new WeakSet(), _Semaphore_enque = function _Semaphore_enque(resolve, reject) {
    var _a;
    ...
    const ticket = [releaser, __classPrivateFieldGet(this, _Semaphore_allowed, "f")];
 ...
 * Semaphore object.
 */
Semaphore.DefaultOptions = { errorCancelled: ErrCancelled };
