...
export default class Semaphore {
    ...
    cancelAll() {
        ...
        __classPrivateFieldGet(this, _Semaphore_queue, "f").forEach(({ reject }) => { var _a; return reject((_a = __classPrivateFieldGet(this, _Semaphore_options, "f").errorCancelled) !== null && _a !== void 0 ? _a : ErrCancelled); });
