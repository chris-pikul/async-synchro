...
class Semaphore {
    ...
    cancelAll() {
        ...
        __classPrivateFieldGet(this, _Semaphore_queue, "f").forEach(({ reject }) => { var _a; return reject((_a = this.options.errorCancelled) !== null && _a !== void 0 ? _a : errors_1.ErrCancelled); });
